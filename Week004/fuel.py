...
# any exceptions like ValueError or ZeroDivisionError. from errno import EILSEQ,

loop = 1

while loop == 1:
    fraction = input("Enter the fraction of fuel remaining: ")
    try:
        ...
        if percent <= 1:
            ...
            print(f"percent of fuel remaining: {percent}%")
            loop = 0
